...
var Index = (function (_React$Component) {
    ...
    _createClass(Index, [{
        ...
        value: function render() {
            var initState = (0, _IndexReducer.CreateStateData)({
                message: {
                    text: "initial message",
                    type: "info"
                }
            });
            return React.createElement(_ReduxFullPageLayout2.default, { "title": this.props.title, "pageName": "index", "reducer": _IndexReducer.Reducer, "initialState": initState }, React.createElement(_IndexApp2.default, { "title": this.props.title }));
        }
    }]);
